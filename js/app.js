(() => {
    ...
    function initSliders() {
        ...
        new swiper_core_Swiper(".staff__slider", {
            modules: [ Navigation ],
            observer: true,
            slidesPerView: 5,
            spaceBetween: 60,
        ...
        new swiper_core_Swiper(".conditions__slider", {
            modules: [ Navigation ],
            observer: true,
            slidesPerView: 3,
            spaceBetween: 24,
        ...
        new swiper_core_Swiper(".service-slider__slider", {
            modules: [ Navigation ],
            observer: true,
            slidesPerView: 4,
            spaceBetween: 24,
        ...
        new swiper_core_Swiper(".photo__slider", {
            modules: [ Navigation ],
            observer: true,
            slidesPerView: "auto",
            spaceBetween: 24,
